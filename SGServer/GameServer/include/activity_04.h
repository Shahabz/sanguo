...
#define ACTIVITY_SEVENDAY_TYPE21	21	//	收集至少{ 0 }件蓝色或以上品质装备v
#define ACTIVITY_SEVENDAY_TYPE22	22	//	收集至少{ 0 }件绿色或以上品质装备v
#define ACTIVITY_SEVENDAY_TYPE23	23	//	收集{ 0 }件蓝色或以上品质兵符v
#define ACTIVITY_SEVENDAY_TYPE24	24	//	收集{ 0 }件蓝色或以上品质头盔v
#define ACTIVITY_SEVENDAY_TYPE25	25	//	收集{ 0 }件绿色或以上品质头盔v
#define ACTIVITY_SEVENDAY_TYPE26	26	//	至少拥有{ 0 }名蓝色或以上将v
#define ACTIVITY_SEVENDAY_TYPE27	27	//	至少拥有{ 0 }名绿色或以上将v
#define ACTIVITY_SEVENDAY_TYPE28	28	//	至少拥有{ 0 }名金色或以上将v
#define ACTIVITY_SEVENDAY_TYPE29	29	//	至少拥有{ 0 }名红色或以上将v
#define ACTIVITY_SEVENDAY_TYPE30	30	//	至少{ 0 }名武将总资质洗髓到上限v
#define ACTIVITY_SEVENDAY_TYPE31	31	//	至少{ 0 }名金色将总资质洗髓到上限v
#define ACTIVITY_SEVENDAY_TYPE32	32	//	{0}件绿色或以上品质装备洗炼到满级v
#define ACTIVITY_SEVENDAY_TYPE33	33	//	{0}件金色或以上品质装备洗炼到满级v
