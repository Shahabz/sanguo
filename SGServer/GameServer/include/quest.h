...
#define DATA_RECORD_KILLTOWNTYPE1				3	// 成功攻打县城次数
#define DATA_RECORD_KILLTOWNTYPE2				4	// 成功攻打郡城次数
#define DATA_RECORD_KILLTOWNTYPE3				5	// 成功攻打治所次数
#define DATA_RECORD_KILLTOWNTYPE4				6	// 成功攻打封地次数
