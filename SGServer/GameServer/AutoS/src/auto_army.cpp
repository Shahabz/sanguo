...
RE_ARMY_TRUNCATE:
	...
	for ( int index = 0; index < maxcount; index++ )
	{
		...
		if ( count == 0 )
		{
			sprintf( g_batchsql, "REPLACE INTO %s (`index`,`id`,`state`,`statetime`,`stateduration`,`action`,`from_type`,`from_id`,`from_index`,`from_posx`,`from_posy`,`to_type`,`to_id`,`to_index`,`to_posx`,`to_posy`,`posx`,`posy`,`appdata`,`silver`,`wood`,`food`,`iron`,`token`,`herokind0`,`herokind1`,`herokind2`,`herokind3`,`awardkind0`,`awardkind1`,`awardkind2`,`awardkind3`,`awardkind4`,`awardkind5`,`awardkind6`,`awardkind7`,`awardnum0`,`awardnum1`,`awardnum2`,`awardnum3`,`awardnum4`,`awardnum5`,`awardnum6`,`awardnum7`) Values('%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d')",pTab,pArmy[index].index,pArmy[index].id,pArmy[index].state,pArmy[index].statetime,pArmy[index].stateduration,pArmy[index].action,pArmy[index].from_type,pArmy[index].from_id,pArmy[index].from_index,pArmy[index].from_posx,pArmy[index].from_posy,pArmy[index].to_type,pArmy[index].to_id,pArmy[index].to_index,pArmy[index].to_posx,pArmy[index].to_posy,pArmy[index].posx,pArmy[index].posy,pArmy[index].appdata,pArmy[index].silver,pArmy[index].wood,pArmy[index].food,pArmy[index].iron,pArmy[index].token,pArmy[index].herokind[0],pArmy[index].herokind[1],pArmy[index].herokind[2],pArmy[index].herokind[3],pArmy[index].awardkind[0],pArmy[index].awardkind[1],pArmy[index].awardkind[2],pArmy[index].awardkind[3],pArmy[index].awardkind[4],pArmy[index].awardkind[5],pArmy[index].awardkind[6],pArmy[index].awardkind[7],pArmy[index].awardnum[0],pArmy[index].awardnum[1],pArmy[index].awardnum[2],pArmy[index].awardnum[3],pArmy[index].awardnum[4],pArmy[index].awardnum[5],pArmy[index].awardnum[6],pArmy[index].awardnum[7]);
		}
		else
		{
			sprintf( szSQL, ",('%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d')",pArmy[index].index,pArmy[index].id,pArmy[index].state,pArmy[index].statetime,pArmy[index].stateduration,pArmy[index].action,pArmy[index].from_type,pArmy[index].from_id,pArmy[index].from_index,pArmy[index].from_posx,pArmy[index].from_posy,pArmy[index].to_type,pArmy[index].to_id,pArmy[index].to_index,pArmy[index].to_posx,pArmy[index].to_posy,pArmy[index].posx,pArmy[index].posy,pArmy[index].appdata,pArmy[index].silver,pArmy[index].wood,pArmy[index].food,pArmy[index].iron,pArmy[index].token,pArmy[index].herokind[0],pArmy[index].herokind[1],pArmy[index].herokind[2],pArmy[index].herokind[3],pArmy[index].awardkind[0],pArmy[index].awardkind[1],pArmy[index].awardkind[2],pArmy[index].awardkind[3],pArmy[index].awardkind[4],pArmy[index].awardkind[5],pArmy[index].awardkind[6],pArmy[index].awardkind[7],pArmy[index].awardnum[0],pArmy[index].awardnum[1],pArmy[index].awardnum[2],pArmy[index].awardnum[3],pArmy[index].awardnum[4],pArmy[index].awardnum[5],pArmy[index].awardnum[6],pArmy[index].awardnum[7]);
