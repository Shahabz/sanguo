...
int city_building_barracks_load_auto( int actorid, int city_index, LPCB_GETBUILDINGBARRACKS pCB_GetBuildingBarracks, const char *pTab )
{
	...
	sprintf( szSQL, "select `actorid`,`offset`,`kind`,`level`,`soldiers`,`trainnum`,`trainsec`,`queuenum0`,`queuenum1`,`queuenum2`,`queuenum3`,`queuenum4`,`queuenum5`,`queuenum6`,`queuenum7`,`queuesec0`,`queuesec1`,`queuesec2`,`queuesec3`,`queuesec4`,`queuesec5`,`queuesec6`,`queuesec7`,`queue`,`trainlong`,`overnum`,`quicksec` from %s where actorid='%d'", pTab, actorid );
...
int city_building_barracks_batch_save_auto( int actorid, BuildingBarracks *pBuildingBarracks, int maxcount, const char *pTab, FILE *fp )
{
	...
	for ( int index = 0; index < maxcount; index++ )
	{
		...
		{
			sprintf( szSQL, ",('%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d','%d')",actorid,index,pBuildingBarracks[index].kind,pBuildingBarracks[index].level,pBuildingBarracks[index].soldiers,pBuildingBarracks[index].trainnum,pBuildingBarracks[index].trainsec,pBuildingBarracks[index].queuenum[0],pBuildingBarracks[index].queuenum[1],pBuildingBarracks[index].queuenum[2],pBuildingBarracks[index].queuenum[3],pBuildingBarracks[index].queuenum[4],pBuildingBarracks[index].queuenum[5],pBuildingBarracks[index].queuenum[6],pBuildingBarracks[index].queuenum[7],pBuildingBarracks[index].queuesec[0],pBuildingBarracks[index].queuesec[1],pBuildingBarracks[index].queuesec[2],pBuildingBarracks[index].queuesec[3],pBuildingBarracks[index].queuesec[4],pBuildingBarracks[index].queuesec[5],pBuildingBarracks[index].queuesec[6],pBuildingBarracks[index].queuesec[7],pBuildingBarracks[index].queue,pBuildingBarracks[index].trainlong,pBuildingBarracks[index].overnum,pBuildingBarracks[index].quicksec);
