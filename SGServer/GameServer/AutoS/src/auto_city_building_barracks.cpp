...
int city_building_barracks_load_auto( int actorid, int city_index, LPCB_GETBUILDINGBARRACKS pCB_GetBuildingBarracks, const char *pTab )
{
	...
	sprintf( szSQL, "select `actorid`,`offset`,`kind`,`level`,`trainnum`,`trainsec`,`trainsec_need`,`queuenum0`,`queuenum1`,`queuenum2`,`queuenum3`,`queuenum4`,`queuenum5`,`queuenum6`,`queuenum7`,`queuenum8`,`queuenum9`,`queuenum10`,`queuesec0`,`queuesec1`,`queuesec2`,`queuesec3`,`queuesec4`,`queuesec5`,`queuesec6`,`queuesec7`,`queuesec8`,`queuesec9`,`queuesec10`,`queue`,`trainlong`,`overnum`,`quicksec` from %s where actorid='%d'", pTab, actorid );
