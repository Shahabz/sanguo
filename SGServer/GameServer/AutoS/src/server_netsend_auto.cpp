...
int netsend_mapunitaction_S( int actor_index, char send_type, SLK_NetS_MapUnitAction *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_MAPUNITACTION; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);
...
int netsend_blackinfo_S( int actor_index, char send_type, SLK_NetS_BlackInfo *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_BLACKINFO; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_BlackInfo_send( &ptr, &tmpsize, pValue );
...
int netsend_blacklist_S( int actor_index, char send_type, SLK_NetS_BlackList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_BLACKLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_BlackList_send( &ptr, &tmpsize, pValue );
...
int netsend_blacklistid_S( int actor_index, char send_type, SLK_NetS_BlackListID *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_BLACKLISTID; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_BlackListID_send( &ptr, &tmpsize, pValue );
...
int netsend_nationequip_S( int actor_index, char send_type, SLK_NetS_NationEquip *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONEQUIP; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationEquip_send( &ptr, &tmpsize, pValue );
...
int netsend_shoplist_S( int actor_index, char send_type, SLK_NetS_ShopList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_SHOPLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ShopList_send( &ptr, &tmpsize, pValue );
...
int netsend_paystore_S( int actor_index, char send_type, SLK_NetS_PayStore *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_PAYSTORE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_PayStore_send( &ptr, &tmpsize, pValue );
...
int netsend_goodsinfo_S( int actor_index, char send_type, SLK_NetS_GoodsInfo *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_GOODSINFO; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_GoodsInfo_send( &ptr, &tmpsize, pValue );
...
int netsend_paystoreactivity_S( int actor_index, char send_type, SLK_NetS_PayStoreActivity *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_PAYSTOREACTIVITY;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_PAYSTOREACTIVITY; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_PayStoreActivity_send( &ptr, &tmpsize, pValue );
...
int netsend_payorder_S( int actor_index, char send_type, SLK_NetS_PayOrder *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_PAYORDER; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_PayOrder_send( &ptr, &tmpsize, pValue );
...
int netsend_vipshop_S( int actor_index, char send_type, SLK_NetS_VipShop *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_VIPSHOP; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_VipShop_send( &ptr, &tmpsize, pValue );
...
int netsend_vipbag_S( int actor_index, char send_type, SLK_NetS_VipBag *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_VIPBAG; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_VipBag_send( &ptr, &tmpsize, pValue );
...
int netsend_buffchange_S( int actor_index, char send_type, SLK_NetS_BuffChange *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_BUFFCHANGE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_BuffChange_send( &ptr, &tmpsize, pValue );
...
int netsend_changeautoguard_S( int actor_index, char send_type, SLK_NetS_ChangeAutoGuard *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_CHANGEAUTOGUARD;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_CHANGEAUTOGUARD; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ChangeAutoGuard_send( &ptr, &tmpsize, pValue );
...
int netsend_activitylist_S( int actor_index, char send_type, SLK_NetS_ActivityList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITYLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ActivityList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationequiplist_S( int actor_index, char send_type, SLK_NetS_NationEquipList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONEQUIPLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONEQUIPLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);
...
int netsend_nationwarlist_S( int actor_index, char send_type, SLK_NetS_NationWarList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONWARLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationWarList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationcitywarlist_S( int actor_index, char send_type, SLK_NetS_NationCityWarList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONCITYWARLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONCITYWARLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationCityWarList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationquestlist_S( int actor_index, char send_type, SLK_NetS_NationQuestList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONQUESTLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONQUESTLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationQuestList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationmissionlist_S( int actor_index, char send_type, SLK_NetS_NationMissionList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONMISSIONLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONMISSIONLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationMissionList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationranklist_S( int actor_index, char send_type, SLK_NetS_NationRankList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONRANKLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationRankList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationofficiallist_S( int actor_index, char send_type, SLK_NetS_NationOfficialList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONOFFICIALLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONOFFICIALLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationOfficialList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationcandidatelist_S( int actor_index, char send_type, SLK_NetS_NationCandidateList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONCANDIDATELIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONCANDIDATELIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationCandidateList_send( &ptr, &tmpsize, pValue );
...
int netsend_worlddataopen_S( int actor_index, char send_type, SLK_NetS_WorldDataOpen *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_WORLDDATAOPEN; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_WorldDataOpen_send( &ptr, &tmpsize, pValue );
...
int netsend_nationreplacelist_S( int actor_index, char send_type, SLK_NetS_NationReplaceList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NATIONREPLACELIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONREPLACELIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationReplaceList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationloglist_S( int actor_index, char send_type, SLK_NetS_NationLogList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONLOGLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationLogList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationherolist_S( int actor_index, char send_type, SLK_NetS_NationHeroList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONHEROLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationHeroList_send( &ptr, &tmpsize, pValue );
...
int netsend_citynationhero_S( int actor_index, char send_type, SLK_NetS_CityNationHero *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_CITYNATIONHERO; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_CityNationHero_send( &ptr, &tmpsize, pValue );
...
int netsend_citynationherolist_S( int actor_index, char send_type, SLK_NetS_CityNationHeroList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_CITYNATIONHEROLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_CITYNATIONHEROLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_CityNationHeroList_send( &ptr, &tmpsize, pValue );
...
int netsend_nationheroattr_S( int actor_index, char send_type, SLK_NetS_NationHeroAttr *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NATIONHEROATTR; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_NationHeroAttr_send( &ptr, &tmpsize, pValue );
...
int netsend_wishingshop_S( int actor_index, char send_type, SLK_NetS_WishingShop *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_WISHINGSHOP; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_WishingShop_send( &ptr, &tmpsize, pValue );
...
int netsend_wishingchange_S( int actor_index, char send_type, SLK_NetS_WishingChange *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_WISHINGCHANGE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_WishingChange_send( &ptr, &tmpsize, pValue );
...
int netsend_wishingpack_S( int actor_index, char send_type, SLK_NetS_WishingPack *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_WISHINGPACK; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_WishingPack_send( &ptr, &tmpsize, pValue );
...
int netsend_tiancequest_S( int actor_index, char send_type, SLK_NetS_TianceQuest *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_TIANCEQUEST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_TianceQuest_send( &ptr, &tmpsize, pValue );
...
int netsend_studentlist_S( int actor_index, char send_type, SLK_NetS_StudentList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_STUDENTLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_StudentList_send( &ptr, &tmpsize, pValue );
...
int netsend_teachershoplist_S( int actor_index, char send_type, SLK_NetS_TeacherShopList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_TEACHERSHOPLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_TEACHERSHOPLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_TeacherShopList_send( &ptr, &tmpsize, pValue );
...
int netsend_activity03list_S( int actor_index, char send_type, SLK_NetS_Activity03List *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITY03LIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Activity03List_send( &ptr, &tmpsize, pValue );
...
int netsend_activity05list_S( int actor_index, char send_type, SLK_NetS_Activity05List *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITY05LIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Activity05List_send( &ptr, &tmpsize, pValue );
...
int netsend_activity01list_S( int actor_index, char send_type, SLK_NetS_Activity01List *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITY01LIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Activity01List_send( &ptr, &tmpsize, pValue );
...
int netsend_activity04list_S( int actor_index, char send_type, SLK_NetS_Activity04List *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITY04LIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Activity04List_send( &ptr, &tmpsize, pValue );
...
int netsend_girllove_S( int actor_index, char send_type, SLK_NetS_GirlLove *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_GIRLLOVE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_GirlLove_send( &ptr, &tmpsize, pValue );
...
int netsend_girlloveresult_S( int actor_index, char send_type, SLK_NetS_GirlLoveResult *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_GIRLLOVERESULT; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_GirlLoveResult_send( &ptr, &tmpsize, pValue );
...
int netsend_fsinfo_S( int actor_index, char send_type, SLK_NetS_FsInfo *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_FSINFO; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_FsInfo_send( &ptr, &tmpsize, pValue );
...
int netsend_fsvisitresult_S( int actor_index, char send_type, SLK_NetS_FsVisitResult *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_FSVISITRESULT; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_FsVisitResult_send( &ptr, &tmpsize, pValue );
...
int netsend_fspalace_S( int actor_index, char send_type, SLK_NetS_FsPalace *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_FSPALACE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_FsPalace_send( &ptr, &tmpsize, pValue );
...
int netsend_fspalaceresult_S( int actor_index, char send_type, SLK_NetS_FsPalaceResult *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_FSPALACERESULT; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_FsPalaceResult_send( &ptr, &tmpsize, pValue );
...
int netsend_girlshop_S( int actor_index, char send_type, SLK_NetS_GirlShop *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_GIRLSHOP; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_GirlShop_send( &ptr, &tmpsize, pValue );
...
int netsend_zonemaster_S( int actor_index, char send_type, SLK_NetS_ZoneMaster *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ZONEMASTER; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ZoneMaster_send( &ptr, &tmpsize, pValue );
...
int netsend_zonemasterlist_S( int actor_index, char send_type, SLK_NetS_ZoneMasterList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ZONEMASTERLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);
...
int netsend_fighthelper_S( int actor_index, char send_type, SLK_NetS_FightHelper *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_FIGHTHELPER; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_FightHelper_send( &ptr, &tmpsize, pValue );
...
int netsend_fighthelperlist_S( int actor_index, char send_type, SLK_NetS_FightHelperList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_FIGHTHELPERLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_FIGHTHELPERLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_FightHelperList_send( &ptr, &tmpsize, pValue );
...
int netsend_redinfo_S( int actor_index, char send_type, SLK_NetS_RedInfo *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_REDINFO; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_RedInfo_send( &ptr, &tmpsize, pValue );
...
int netsend_tokensale_S( int actor_index, char send_type, SLK_NetS_TokenSale *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_TOKENSALE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_TokenSale_send( &ptr, &tmpsize, pValue );
...
int netsend_tokenret_S( int actor_index, char send_type, SLK_NetS_TokenRet *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_TOKENRET; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_TokenRet_send( &ptr, &tmpsize, pValue );
...
int netsend_activity33_S( int actor_index, char send_type, SLK_NetS_Activity33 *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITY33; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Activity33_send( &ptr, &tmpsize, pValue );
...
int netsend_NetS_EDayQuestList_S( int actor_index, char send_type, SLK_NetS_EDayQuestList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NETS_EDAYQUESTLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NETS_EDAYQUESTLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_EDayQuestList_send( &ptr, &tmpsize, pValue );
...
int netsend_NetS_EDayShopList_S( int actor_index, char send_type, SLK_NetS_EDayShopList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_NETS_EDAYSHOPLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NETS_EDAYSHOPLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_EDayShopList_send( &ptr, &tmpsize, pValue );
...
int netsend_NetS_EDayPoint_S( int actor_index, char send_type, SLK_NetS_EDayPoint *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_NETS_EDAYPOINT; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_EDayPoint_send( &ptr, &tmpsize, pValue );
...
int netsend_activity17_S( int actor_index, char send_type, SLK_NetS_Activity17 *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACTIVITY17; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Activity17_send( &ptr, &tmpsize, pValue );
...
int netsend_coliseumlist_S( int actor_index, char send_type, SLK_NetS_ColiseumList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_COLISEUMLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ColiseumList_send( &ptr, &tmpsize, pValue );
...
int netsend_coliseumranklist_S( int actor_index, char send_type, SLK_NetS_ColiseumRankList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_COLISEUMRANKLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_COLISEUMRANKLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ColiseumRankList_send( &ptr, &tmpsize, pValue );
...
int netsend_coliseumlog_S( int actor_index, char send_type, SLK_NetS_ColiseumLog *pValue )
{
	char tmpbuf[2048];
	int tmpsize;
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_COLISEUMLOG;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_COLISEUMLOG; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ColiseumLog_send( &ptr, &tmpsize, pValue );
...
int netsend_coliseumloglist_S( int actor_index, char send_type, SLK_NetS_ColiseumLogList *pValue )
{
	char tmpbuf[2048];
	int tmpsize;
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_COLISEUMLOGLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_COLISEUMLOGLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ColiseumLogList_send( &ptr, &tmpsize, pValue );
...
int netsend_coliseumfight_S( int actor_index, char send_type, SLK_NetS_ColiseumFight *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_COLISEUMFIGHT; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ColiseumFight_send( &ptr, &tmpsize, pValue );
...
int netsend_coliseumawardlist_S( int actor_index, char send_type, SLK_NetS_ColiseumAwardList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_COLISEUMAWARDLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_COLISEUMAWARDLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_ColiseumAwardList_send( &ptr, &tmpsize, pValue );
...
int netsend_everydaysigninlist_S( int actor_index, char send_type, SLK_NetS_EverydaySigninList *pValue )
{
	...
	char *ptrsubdata;
	char *ptr, *ptrsize;
	short cmd=CMDS_EVERYDAYSIGNINLIST;
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_EVERYDAYSIGNINLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_EverydaySigninList_send( &ptr, &tmpsize, pValue );
...
int netsend_act22army_S( int actor_index, char send_type, SLK_NetS_Act22Army *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACT22ARMY; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Act22Army_send( &ptr, &tmpsize, pValue );
...
int netsend_act22armylist_S( int actor_index, char send_type, SLK_NetS_Act22ArmyList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACT22ARMYLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Act22ArmyList_send( &ptr, &tmpsize, pValue );
...
int netsend_act22ranklist_S( int actor_index, char send_type, SLK_NetS_Act22RankList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACT22RANKLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Act22RankList_send( &ptr, &tmpsize, pValue );
...
int netsend_act22update_S( int actor_index, char send_type, SLK_NetS_Act22Update *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACT22UPDATE; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Act22Update_send( &ptr, &tmpsize, pValue );
...
int netsend_act22log_S( int actor_index, char send_type, SLK_NetS_Act22Log *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACT22LOG; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Act22Log_send( &ptr, &tmpsize, pValue );
...
int netsend_act22loglist_S( int actor_index, char send_type, SLK_NetS_Act22LogList *pValue )
{
	...
	ptr+=sizeof(short);
	ptrsubdata = ptr;
	*(short *)ptr = CMDS_ACT22LOGLIST; ptr+=sizeof(short); tmpsize+=sizeof(short);
	ptrsize = ptr;	ptr+=sizeof(short);tmpsize+=sizeof(short);

	struct_NetS_Act22LogList_send( &ptr, &tmpsize, pValue );
