CREATE TABLE `city` (
  ...
  `nequip_level` varbinary(24) NOT NULL DEFAULT '' COMMENT '国器等级',
  `nequip_exp` varbinary(24) NOT NULL DEFAULT '' COMMENT '国器经验',
  `nequip_kind` tinyint(3) NOT NULL DEFAULT '0' COMMENT '正在改造的国器',
  `nequip_pro` tinyint(3) NOT NULL DEFAULT '0' COMMENT '正在改造的进度',
  `nequip_sec` int(11) NOT NULL DEFAULT '0' COMMENT '国器改造时间',
