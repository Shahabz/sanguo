CREATE TABLE `city` (
  ...
  `tc_level` varbinary(8) NOT NULL DEFAULT '' COMMENT '天策府科技等级',
  `tc_progress` varbinary(8) NOT NULL DEFAULT '' COMMENT '天策府科技进度',
  ...
  `edquest` varbinary(128) NOT NULL DEFAULT '' COMMENT '每日任务',
