...
ITEM_COLOR_LEVEL_GREEN	= 1 -- 绿色
ITEM_COLOR_LEVEL_BLUE	= 2 -- 蓝色
ITEM_COLOR_LEVEL_PURPLE	= 3 -- 紫色
ITEM_COLOR_LEVEL_GOLD	= 4 -- 金色
ITEM_COLOR_LEVEL_RED	= 5 -- 红色
ITEM_COLOR_LEVEL_MAX	= 6 -- 最大颜色数量
