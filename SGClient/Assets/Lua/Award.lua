...
function AwardInfo( awardkind )
	...
	elseif awardkind == AWARDKIND_TOKEN_SALE then -- 元宝抵扣点数
		sprite = LoadSprite( "item_icon_490" );
		color = ItemColorSprite( 5 );
		name = item_getname( 490 )
		c = 5
		desc = item_getdesc( 490 )
		
	elseif awardkind == AWARDKIND_TOKEN_RET then -- 元宝返还次数
		sprite = LoadSprite( "item_icon_491" );
		color = ItemColorSprite( 3 );
