...
function netrecv_girlloveresult_C( buffer )
	local recvValue = struct_NetS_GirlLoveResult_recv( buffer );
...
function netrecv_fspalace_C( buffer )
	local recvValue = struct_NetS_FsPalace_recv( buffer );
...
function netrecv_NetS_EDayPoint_C( buffer )
	local recvValue = struct_NetS_EDayPoint_recv( buffer );
	proc_NetS_EDayPoint_C( recvValue );
end

function netrecv_activity17_C( buffer )
	local recvValue = struct_NetS_Activity17_recv( buffer );
	proc_activity17_C( recvValue );
end

function netrecv_coliseumlist_C( buffer )
	local recvValue = struct_NetS_ColiseumList_recv( buffer );
	proc_coliseumlist_C( recvValue );
end

function netrecv_coliseumranklist_C( buffer )
	local recvValue = struct_NetS_ColiseumRankList_recv( buffer );
	proc_coliseumranklist_C( recvValue );
end

function netrecv_coliseumlog_C( buffer )
	local recvValue = struct_NetS_ColiseumLog_recv( buffer );
	proc_coliseumlog_C( recvValue );
end

function netrecv_coliseumloglist_C( buffer )
	local recvValue = struct_NetS_ColiseumLogList_recv( buffer );
...
function netrecv_coliseumawardlist_C( buffer )
	local recvValue = struct_NetS_ColiseumAwardList_recv( buffer );
	proc_coliseumawardlist_C( recvValue );
end

function netrecv_everydaysigninlist_C( buffer )
	local recvValue = struct_NetS_EverydaySigninList_recv( buffer );
...
Proc_Command = {
	...
	[CMDS_NETS_EDAYPOINT]=netrecv_NetS_EDayPoint_C;
	[CMDS_ACTIVITY17]=netrecv_activity17_C;
	[CMDS_COLISEUMLIST]=netrecv_coliseumlist_C;
