...
public class UITweenJumpWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UITweenJump), typeof(UITween));
	...
	static int ToInit(IntPtr L)
	{
		try
		{
			...
			UITweenJump obj = (UITweenJump)ToLua.CheckObject(L, 1, typeof(UITweenJump));
			obj.ToInit();
			return 0;
		}
		catch(Exception e)
	...
	static int get_end(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UITweenJump obj = (UITweenJump)o;
			UnityEngine.Vector3 ret = obj.end;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
