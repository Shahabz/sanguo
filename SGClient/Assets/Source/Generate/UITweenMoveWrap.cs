...
public class UITweenMoveWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UITweenMove), typeof(UITween));
	...
	static int ToInit(IntPtr L)
	{
		try
		{
			...
			UITweenMove obj = (UITweenMove)ToLua.CheckObject(L, 1, typeof(UITweenMove));
			obj.ToInit();
			return 0;
		}
		catch(Exception e)
