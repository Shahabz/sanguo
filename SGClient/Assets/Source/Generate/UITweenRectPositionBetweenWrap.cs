...
public class UITweenRectPositionBetweenWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UITweenRectPositionBetween), typeof(UITween));
	...
	static int ToInit(IntPtr L)
	{
		try
		{
			...
			UITweenRectPositionBetween obj = (UITweenRectPositionBetween)ToLua.CheckObject(L, 1, typeof(UITweenRectPositionBetween));
			obj.ToInit();
			return 0;
		}
		catch(Exception e)
	...
	static int get_x(IntPtr L)
	{
		...
		try
		{
			...
			UITweenRectPositionBetween obj = (UITweenRectPositionBetween)o;
			float ret = obj.x;
